...
If you met an error message saying: "Error in load.image(filename) : could not find function 'load.image'", please make sure to run the following line to proceed:
