...
`wordCloud` create the image based on a web link which contains textual data. If you're running the code in Rstudio, the wordcloud image might be shown under `Plots` tab which is next to `Files` browser tab.
